...
public record MakePaymentResult(Payment? Data, Status Status, string Message) : Result(Status, Message)
{
    ...
    public static MakePaymentResult Unauthorized()
        => new MakePaymentResult(Data: null, Status.Unauthorized, "The payment was declined by the call to the acquiring bank");
